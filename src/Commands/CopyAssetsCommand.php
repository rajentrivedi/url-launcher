...
namespace Rajen\NativePhpUrlLauncher\Commands;

use Native\Mobile\Plugins\Commands\NativePluginHookCommand;

/**
 * Copy assets hook command for UrlLauncher plugin.
 *
...
{
    protected $signature = 'nativephp:url-launcher:copy-assets';

    protected $description = 'Copy assets for UrlLauncher plugin';
    ...
    protected function copyAndroidAssets(): void
    {
        ...
        $this->info('Android assets copied for UrlLauncher');
    }
    ...
    protected function copyIosAssets(): void
    {
        ...
        $this->info('iOS assets copied for UrlLauncher');
    }
}